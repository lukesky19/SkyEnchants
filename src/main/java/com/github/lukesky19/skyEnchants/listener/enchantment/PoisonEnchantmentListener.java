...
public class PoisonEnchantmentListener implements Listener {
    ...
    private final @NonNull PoisonConfigManager poisonConfigManager;
    ...
    public void onEntityDamaged(EntityDamageByEntityEvent entityDamageByEntityEvent) {
        Poison poison = poisonConfigManager.getConfiguration();
        if(poison == null) {
        ...
        Enchantment poisonEnchantment = enchantmentManager.getPoisonEnchantment();
        ...
        List<EquipmentSlot> equipmentSlots = PluginUtils.getEquipmentSlots(poison.getRegistrationConfig().equipmentSlots());
        ...
        Map<Integer, Integer> effectDurationPerLevel = poison.effectDurationPerLevel();
        Map<Integer, Integer> effectAmplifierPerLevel = poison.effectAmplifierPerLevel();
