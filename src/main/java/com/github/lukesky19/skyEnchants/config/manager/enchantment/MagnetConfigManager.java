...
/**
 * This class manages the {@link Magnet} configuration.
 */
public class MagnetConfigManager extends EnchantmentConfigManager<Magnet> {
    /**
     * Constructor
     ...
     * @param magnet The {@link Magnet} configuration.
