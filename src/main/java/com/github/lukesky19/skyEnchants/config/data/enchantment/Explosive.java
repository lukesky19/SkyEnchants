...
/**
 * This record contains the configuration for the explosive enchantment.
 * @param version The config version.
 * @param enabled Is the enchantment enabled?
 * @param registration The {@link Registration} config for the enchantment.
 * @param explosionPowerPerLevel The {@link Map} mapping enchantment levels to explosion power.
 */
@ConfigSerializable
public record Explosive(
        ...
        @NonNull Map<Integer, Integer> explosionPowerPerLevel) implements IEnchantmentConfig {
    @Override
    ...
    public @NonNull TypedKey<@NonNull Enchantment> getTypedKey() {
        return EnchantmentKeys.create(Key.key("skyenchants", "explosive"));
    }
