...
/**
 * This record contains the configuration for the speed enchantment.
 * @param version The config version.
 * @param enabled Is the enchantment enabled?
 * @param registration The {@link Registration} config for the enchantment.
 * @param speedPerLevel The {@link Map} mapping enchantment levels to speed amounts.
 */
@ConfigSerializable
public record Speed(
        int version,
        ...
        @NotNull Map<Integer, Double> speedPerLevel) implements IEnchantmentConfig {
    @Override
    ...
    public @NotNull TypedKey<@NotNull Enchantment> getTypedKey() {
        return EnchantmentKeys.create(Key.key("skyenchants", "speed"));
    }
