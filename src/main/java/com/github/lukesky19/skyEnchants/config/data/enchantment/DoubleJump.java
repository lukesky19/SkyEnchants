 ...
 * @param velocityPerLevel The {@link Map} mapping enchantment levels to velocity.
 */
@ConfigSerializable
public record DoubleJump(
        ...
        @NotNull Map<Integer, Double> velocityPerLevel) implements IEnchantmentConfig {
    @Override
    ...
    public @NotNull TypedKey<@NotNull Enchantment> getTypedKey() {
        return EnchantmentKeys.create(Key.key("skyenchants", "double_jump"));
    }
