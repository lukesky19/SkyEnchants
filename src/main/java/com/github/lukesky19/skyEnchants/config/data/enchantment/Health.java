...
/**
 * This record contains the configuration for the health enchantment.
 * @param version The config version.
 * @param enabled Is the enchantment enabled?
 * @param registration The {@link Registration} config for the enchantment.
 * @param healthPerLevel The {@link Map} mapping enchantment levels to health amounts.
 */
@ConfigSerializable
public record Health(
        ...
        @NonNull Map<Integer, Integer> healthPerLevel) implements IEnchantmentConfig {
    @Override
    ...
    public @NonNull TypedKey<@NonNull Enchantment> getTypedKey() {
        return EnchantmentKeys.create(Key.key("skyenchants", "health"));
    }
