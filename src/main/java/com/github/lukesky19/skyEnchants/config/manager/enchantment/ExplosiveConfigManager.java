...
/**
 * This class manages the {@link Explosive} configuration.
 */
public class ExplosiveConfigManager extends EnchantmentConfigManager<Explosive> {
    /**
     * Constructor
     ...
     * @param explosive The {@link Explosive} configuration.
